            ...
            <div class="overview">
                ...
                <div class="overview-right">
                    <div class="score-wrapper"> <span class="title">服务态度</span> 
                        <Star :score="4.6" :size="36" /> <span class="score">{{info.serviceScore}}</span> 
                    </div>
                    <div class="score-wrapper"> <span class="title">商品评分</span> 
                        <Star :score="4.7" :size="36" /> <span class="score">{{info.foodScore}}</span> 
                    </div>
...
export default {
  data () {
    return {
      ...
      selectType:2//选择的评价类型：0：满意 1：不满意 2：全部评价
    }
  },
